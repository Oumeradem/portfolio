     ...
     <RevealOnScroll>
        <div className="px-4 w-full max-w-lg mx-auto">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <button type="submit" className="w-full bg-blue-500 text-white py-3 px-6 rounded font-medium transition relative overflow-hidden hover:translate-y-0.5 hover:shadow-[0_0_15px_rgba(59,139,246,0.4)] cursor-pointer "
                >
                    Send Message
                </button>
