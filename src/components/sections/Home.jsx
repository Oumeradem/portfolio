            ...
            <RevealOnScroll>
                ...
                <div className="text-center z-10 px-4">
                    ...
                    <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
                        ...
                        I build test frameworks that eliminate bugs before they
                        reach production.
                    </p>
                    <div className="flex justify-center flex-wrap gap-3">
                        ...
                        <a
                            href="/Adem_Resume.pdf"
                            download="Oumer_Adem_Resume.pdf"
                            className="bg-cyan-500 text-white py-3 px-6 rounded font-medium transition hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(6,182,212,0.4)]"
                        >
                            Download Resume
                        </a>
                    </div>
